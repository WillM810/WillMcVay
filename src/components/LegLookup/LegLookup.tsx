        ...
        <div className="p-5 sm:p-10">
            ...
            {data && (
                <div className="mt-6 p-4 border border-gray-300 rounded-lg bg-gray-50">
                    ...
                    <div className="mb-8">
                        {Math.abs(data.location.y).toFixed(2) +
                            (data.location.y > 0 ? "N" : "S")}
                        ,{" "}
                        {Math.abs(data.location.x).toFixed(2) +
                            (data.location.x > 0 ? "E" : "W")}
                    </div>
                    <div className="flex flex-wrap justify-between gap-4 mb-12">
                        <div
                            id="sen"
                            className="flex items-start gap-4 flex-1 min-w-[320px] max-w-[40%]"
                        >
                            <img
                            ...
                            <div>
                                <h3 className="font-semibold">
                                    ...
                                    <span className="whitespace-nowrap">
                                        ...
                                        {data.representative.party}-{data.rd})
                                    </span>
                                </h3>
                    ...
                    <div className="mb-12 px-5">
                        ...
                        <p>
                            ...
                            <span className="whitespace-nowrap">
                                {data.countyAtLarge.name}{" "}
                                <span className="italic">(At-Large)</span>
                            </span>
                        </p>
                    </div>
